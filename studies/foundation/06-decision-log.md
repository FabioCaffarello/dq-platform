...
| W3-P4e | HTTP trigger handler — exposes POST `/v1/trigger`, dispatches to runner per ADR-0002 with the contract committed by the W3-P4e trigger-handler-contract study (provisional ADR-0014 slot). Depends on W3-P4a/b/c/d. Renumbered from W3-P6b on 2026-05-22. | [resolved-study](../decisions/2026-05-22-trigger-handler-contract.md) |
...
| W3-P6d | First entity rule YAML + first `_owners.yaml` entry + end-to-end demo target. Depends on W3-P6a, W3-P6c, and W3-P4e. Closes the C-W2-3.4 invariant locally. | open |
