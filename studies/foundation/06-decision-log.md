...
- Last updated: 2026-05-25 (B2-7 → ADR-0038: documentation site generator deferred with four auditable trigger conditions — external-audience commitment, navigation-density threshold on `docs/README.md`, retrospective-surfaced search-quality friction, external link-out demand; raw markdown stays the deliverable; ADR-0011 and ADR-0019 preserved)
