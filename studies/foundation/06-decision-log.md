...
- Last updated: 2026-05-25 (B2-10 → ADR-0036: `dq-manifest set-pointer` rollback subcommand committed; runbook §3 rewritten with the new primary path + two demoted fallbacks; one deferred OQ-1 `list-pointers` ergonomic registered for future B-item)
