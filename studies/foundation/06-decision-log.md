...
| W3-P4e | HTTP trigger handler — exposes POST `/v1/trigger`, dispatches to runner per ADR-0002 with the contract committed by ADR-0014. Depends on W3-P4a/b/c/d. Renumbered from W3-P6b on 2026-05-22. | [resolved-study](../decisions/2026-05-22-trigger-handler-contract.md) → [resolved-adr](../../docs/adr/0014-trigger-handler-contract.md) |
