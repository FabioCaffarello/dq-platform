...
| W3-P7b | Deploy base — Kubernetes manifests for the engine in `deploy/base/`. Depends on W3-P7a. | open |
| W3-P7c | Per-env overlays — `deploy/overlays/{local,qa,prod}/` setting `DQ_ENV` and the emulator overrides per env. Depends on W3-P7a + W3-P7b. | open |
